...
const WhatMakesUsDifferent = () => {
  return (
     <section className="bg-white md:h-screen pt-10 md:pt-28 pb-10 md:pb-0">
  <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-20 items-start">
