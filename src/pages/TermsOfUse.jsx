    ...
    <div className="bg-white pt-5 pb-24">
      <div className="max-w-6xl mx-auto px-6 text-gray-800 leading-relaxed space-y-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="border border-orange-500 text-orange-500 px-10 py-2 uppercase tracking-wider font-medium">
            Terms & Conditions
          </div>
        </div>
        ...
        <h3 className="font-semibold text-lg">1. Changes to the User Agreement</h3>
        <p>
        ...
        <h3 className="font-semibold text-lg">2. Viewing the Website</h3>
        <p>
        ...
        <h3 className="font-semibold text-lg">3. Responsible Use and Conduct</h3>
        <p>
          By visiting our website and accessing the information, resources, services, products, and tools we provide
        ...
        <h3 className="font-semibold text-lg">6. Limitation of Warranties</h3>
        <p>
        ...
        <h3 className="font-semibold text-lg">8. Copyrights/Trademarks</h3>
        <p>
        ...
        <h3 className="font-semibold text-lg">9. Termination of Use</h3>
        <p>
