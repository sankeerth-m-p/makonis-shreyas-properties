...
const TermsOfUse = () => {
  return (
    <div className="bg-white pt-5 pb-24">
      <div className="max-w-[1120px] mx-auto px-0text-gray-700 space-y-6 md:text-[20px] text-sm leading-relaxed">
...
Terms Of Use
        ...
        <h3 className="font-semibold text-[20px]">1. Changes to the User Agreement</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">2. Viewing the Website</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">3. Responsible Use and Conduct</h3>
        <p>
          By visiting our website and accessing the information, resources, services, products, and tools we provide
        ...
        <h3 className="font-semibold text-[20px]">5. Privacy</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">6. Limitation of Warranties</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">7. Limitation of Liability</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">8. Copyrights/Trademarks</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">9. Termination of Use</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">10. Governing Law</h3>
        <p>
        ...
        <h3 className="font-semibold text-[20px]">11. Contact Information</h3>
        <p>
